...
<div class="main-header">
    <h1>🎬 YouTube Q&A</h1>
    <p>Ask anything about any YouTube video using AI — 100% Free</p>
</div>
...
{transcript[:8000]}"""
    ...
    chat_history = []
    for h in history:
        chat_history.append({"role": "user", "parts": [h["question"]]})
...
<div class="info-box">
    ...
    Get your free key: Go to <code>aistudio.google.com</code> → Sign in with Google → Click <code>Get API Key</code> → <code>Create API key</code>
</div>
""", unsafe_allow_html=True)
...
st.markdown('<div class="footer">Built with Streamlit + Google Gemini AI — 100% Free</div>', unsafe_allow_html=True)
